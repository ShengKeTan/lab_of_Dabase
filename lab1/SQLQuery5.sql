...
--2.2
--(1)
--INSERT INTO lab2.dbo.MBLOG VALUES(7,'_华中科技大学',5,2019,5,9,'大家好！我是菜蝑蜫！');
--DELETE FROM lab2.dbo.MBLOG WHERE lab2.dbo.MBLOG.BID=7;
--UPDATE lab2.dbo.MBLOG SET lab2.dbo.MBLOG.PDAY=10 WHERE BID=7; 
--INSERT INTO lab2.dbo.THUMB VALUES(5,7);
--(2)
/*
...
--(9)
/*
SELECT BID, COUNT(*) AS '次数' FROM lab2.dbo.THUMB, lab2.dbo.[USER]
WHERE lab2.dbo.[USER].UID=lab2.dbo.THUMB.UID
AND lab2.dbo.[USER].BYEAR>2000
GROUP BY BID HAVING COUNT(*)>1;
*/
--(10)
...
WHERE BID IN(SELECT BID FROM lab2.dbo.THUMB, lab2.dbo.[USER]
             WHERE lab2.dbo.THUMB.UID=lab2.dbo.[USER].UID
			 AND lab2.dbo.[USER].BYEAR>2000
			 GROUP BY BID HAVING COUNT(*)>1)
GROUP BY BID;
*/
...
--DROP VIEW IF EXISTS HOTBLOG;
/*
CREATE VIEW HOTBLOG
AS
SELECT lab2.dbo.TOPDAY.BID, TITLE, lab2.dbo.[USER].UID, NAME, COUNT(lab2.dbo.THUMB.UID) AS '点赞次数'
FROM lab2.dbo.TOPDAY, lab2.dbo.[USER], lab2.dbo.MBLOG LEFT OUTER JOIN lab2.dbo.THUMB
ON(lab2.dbo.MBLOG.BID=lab2.dbo.THUMB.BID)
--FROM lab2.dbo.MBLOG, lab2.dbo.[USER], lab2.dbo.TOPDAY, lab2.dbo.THUMB
WHERE TDAY=DAY(GETDATE()) AND TMONTH=MONTH(GETDATE()) AND TYEAR=YEAR(GETDATE())
AND lab2.dbo.MBLOG.BID=lab2.dbo.TOPDAY.BID
AND lab2.dbo.MBLOG.UID=lab2.dbo.[USER].UID
AND lab2.dbo.THUMB.BID=lab2.dbo.TOPDAY.BID
GROUP BY lab2.dbo.TOPDAY.BID, TITLE, lab2.dbo.[USER].UID, NAME;
*/
